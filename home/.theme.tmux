...
set -g status-left "#[fg=colour232,bg=colour192] #S #[fg=colour192,bg=colour235,nobold,nounderscore,noitalics]#[fg=colour192,bg=colour235] #(whoami)  #(uptime | cut -d \" \" -f 1,2,3) #[fg=colour235,bg=colour235,nobold,nounderscore,noitalics]"
